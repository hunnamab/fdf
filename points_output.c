...
void	get_x_line(p_point point_f, p_point point_s, int length, c_cntrl *cntrl)
{
	int x;
	int y;
	int d;
...
void	get_y_line(p_point point_f, p_point point_s, int length, c_cntrl *cntrl)
{
	int x;
	int y;
	int d;
...
void	norme(p_point *points, c_cntrl *cntrl, int i, int a)
{
	while (i < a - 1)
	{
